...
static UINT32 ov5648_cheak_sensor_module_id(void)
{
	...
	if (0x07 == module_integrator_id)
	{
		printk("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ OLY O_5648. \n");
                sprintf(factory_module_id,"sub_camera:5M-Camera ov5648-ofilm\n");  //set camera device info by miaolei@yulong.com 2015.05.26
		compatible_sensorid = OV5648_SENSOR_ID ;
	}	
	else if (0x06 == module_integrator_id)
	{
		printk("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ qtech 5648. \n");
                sprintf(factory_module_id,"sub_camera:5M-Camera ov5648-qtech\n");  //set camera device info by miaolei@yulong.com 2015.05.26
		//delete by yulong miaolei@yulong 0408
		//compatible_sensorid = OV5648QTECHMIPI_SENSOR_ID ;
		compatible_sensorid = OV5648_SENSOR_ID ;//gaoatao add 2015-4-4 21:09:24
	}	
	else
	{
		printk("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ mode unknow \n");
                sprintf(factory_module_id,"sub_camera:5M-Camera ov5648-unknow\n"); //set camera device info by miaolei@yulong.com 2015.05.26
	}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    //start:add by gaoatao for optimize available machine time 2014-11-19 17:01:57
    if (imgsensor_info.sensor_id != *sensor_id)
	{
	    *sensor_id = 0xffffffff;
        return ERROR_SENSOR_CONNECT_FAIL;
	}
    //end:add by gaoatao for optimize available machine time 2014-11-19 17:01:57    
    sensor_init();
    ...
    if (*sensor_id != OV5648_SENSOR_ID) {
        ...
        *sensor_id = 0xFFFFFFFF;
		...
		//delete by yulong miaolei@yulong.com 0408
        get_device_info(factory_module_id);       //set camera device info by miaolei@yulong.com 2015.05.25
    }
