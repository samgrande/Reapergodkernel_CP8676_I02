...
static imgsensor_info_struct imgsensor_info = { 
	...
	.checksum_value = 0xe2c2054e,            //0x6d01485c
	...
	#endif
	#if 0
//use preview setting instead to verify color difference problem
				.pclk = 153600000,				//record different mode's pclk
		.linelength = 4008,				//record different mode's linelength
		.framelength = 1256,			//record different mode's framelength
		.startx =0,					//record different mode's startx of grabwindow
...
{
 { 3264, 2448,    0,    0, 3264, 2448,  1624, 1224, 0000, 0000, 1624, 1224,      0,    0, 1624, 1224}, // preview
 { 3264, 2448,      0,    0, 3264, 2448, 3264, 2448, 0000, 0000, 3264, 2448,      0,    0,  3264, 2448}, // capture
 { 3264, 2448,     0,    0, 3264, 2448,  1624, 1224, 0000, 0000, 1624, 1224,      0,    0, 1624, 1224}, // video  //1632--->1624
 { 3264, 2448,     0, 0, 3264, 2448, 640, 480,  0, 0, 640, 480,      0,    0, 640, 480,}, //hight speed video
 { 3264, 2448,     0,  0, 3264, 2448, 1280,  720, 0, 0, 1280,  720,      0,    0, 1280,  720}};// slim video
...
static int read_otp_info_wb(int index, struct otp_struct *otp_ptr)
{
	...
	printk(KERN_ERR"module_integrator_id : %d, (*otp_ptr).lens_id:%d, (*otp_ptr).vcm_id:%d\n", (*otp_ptr).module_integrator_id, (*otp_ptr).lens_id, (*otp_ptr).vcm_id);
...
{
	LOG_INF("set_gain wenwuxu 's latest empty_version");
	#if 1
