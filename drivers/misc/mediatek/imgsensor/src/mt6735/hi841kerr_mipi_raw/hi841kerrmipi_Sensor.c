...
#include "hi841kerrmipi_Sensor.h"

#define PFX "HI841KERR_camera_sensor"
...
static imgsensor_struct imgsensor = {
	.mirror = IMAGE_V_MIRROR,	//	IMAGE_HV_MIRROR	IMAGE_NORMAL	//mirrorflip information
...
{{ 3264, 2448,      0,    0, 3264, 2448, 3264, 2448, 0000, 0000, 3264, 2448,      0,    0,  3264, 2448}, // Preview
 { 3264, 2448,    0,    0, 3264, 2448,  3264, 2448, 0000, 0000, 1632, 1224,      0,    0, 1632, 1224}, // capture
 ...
 { 3264, 2448,     352,  504, 2560, 1440, 2560, 1440, 0000, 0000, 1280,  720,      0,    0, 1280,  720}};// slim video
...
static int read_otp_info_wb(int index, struct otp_struct *otp_ptr)
{
	...
	uint16_t wb_unit_rg_h = 0, wb_unit_rg_l = 0, wb_unit_bg_h = 0, wb_unit_bg_l = 0,
		 wb_unit_gg_h = 0, wb_unit_gg_l = 0, wb_golden_rg_h = 0, wb_golden_rg_l = 0,
		 wb_golden_bg_h = 0, wb_golden_bg_l = 0, wb_golden_gg_h = 0, wb_golden_gg_l = 0;
	uint16_t rg_golden_value = 0,  bg_golden_value = 0,  rg_value = 0,  bg_value = 0;
...
// call this function after HI841KERR initialization
// return value: 0 update success
// 1, no OTP
...
static UINT32 hi841_cheak_module_id(void)
{
	...
	printk("gaoatao get g_otp_id = %x\n",g_otp_id);
		...
		{
			printk("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ hi841 kerr \n");
			sprintf(factory_module_id,"main camera: hi841 kerr \n");
			compatible_sensorid = HI841KERR_SENSOR_ID;
		}
		else if (0x02 == g_otp_id)
		{
			printk("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ hi841 zhengqiao. \n");
			sprintf(factory_module_id,"main camera: hi841 zhengqiao \n");
...
//	sensor_init();
    *sensor_id=hi841_cheak_module_id();
		printk("HI841KERRGetSensorID *sensorID = 0x%x ", *sensor_id);
    if (*sensor_id != HI841KERR_SENSOR_ID) {
        *sensor_id = 0xFFFFFFFF;
        return ERROR_SENSOR_CONNECT_FAIL;
    }else if(info_limit<1){
        //get_device_info(factory_module_id); //modify for build error by miaolei@yulong.com 2015.04.27
	}
	info_limit++;
...
static kal_uint32 open(void)
{
	...
	sensor_init();
	LOG_INF("A\n");
#ifdef HI841KERRMIPI_USE_OTP
   if(update_otp_lsc()!=0)
		{
					LOG_INF("HI841KERR LSC in no OTP \n ");
		}
		else
		{
		      LOG_INF("HI841KERR_OTP_LSC is  update successful \n ");
		}
		if(update_otp_wb()!=0)
		{
					LOG_INF("HI841KERR AWB no  OTP \n ");
		}
		else
		{
		    	LOG_INF("HI841KERR_OTP_AWB  is  update successful \n ");
		}
#endif
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	preview_setting();
	set_mirror_flip(IMAGE_V_MIRROR);//gaoatao 2015-1-13 20:25:37
	return ERROR_NONE;
}	/*	preview   */
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    switch (scenario_id) {
        case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
              LOG_INF("MSDK_SCENARIO_ID_CAMERA_PREVIEW E\n");
...
LOG_INF("MSDK_SCENARIO_ID_VIDEO_PREVIEW E\n");
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	switch (scenario_id) {
		case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
			...
			LOG_INF("MSDK_SCENARIO_ID_CAMERA_PREVIEW preview\n");
			preview(image_window, sensor_config_data);
			break;
		case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
			case MSDK_SCENARIO_ID_CAMERA_ZSD:
			    LOG_INF("MSDK_SCENARIO_ID_CAMERA_ZSD \n");
...
LOG_INF("set_max_framerate_by_scenario enter \n");
    switch (scenario_id) {
        case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
            LOG_INF("MSDK_SCENARIO_ID_CAMERA_PREVIEW enter \n");
...
static kal_uint32 get_default_framerate_by_scenario(MSDK_SCENARIO_ID_ENUM scenario_id, MUINT32 *framerate)
{
 ...
 LOG_INF("get_default_framerate_by_scenario enter \n");
    switch (scenario_id) {
        case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    LOG_INF("feature_id = %d\n", feature_id);
     LOG_INF("feature_control enter \n");
    switch (feature_id) {
        case SENSOR_FEATURE_GET_PERIOD:
             LOG_INF("SENSOR_FEATURE_GET_PERIOD enter \n");
            *feature_return_para_16++ = imgsensor.line_length;
            *feature_return_para_16 = imgsensor.frame_length;
            *feature_para_len=4;
            break;
        case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ:
             LOG_INF("SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ enter \n");
            *feature_return_para_32 = imgsensor.pclk;
            *feature_para_len=4;
            break;
        case SENSOR_FEATURE_SET_ESHUTTER:
            LOG_INF("SENSOR_FEATURE_SET_ESHUTTER enter \n");
        ...
        case SENSOR_FEATURE_SET_REGISTER:
            LOG_INF("SENSOR_FEATURE_SET_REGISTER enter \n");
        ...
        case SENSOR_FEATURE_CHECK_SENSOR_ID:
            LOG_INF("SENSOR_FEATURE_CHECK_SENSOR_ID enter \n");
            get_imgsensor_id(feature_return_para_32);
            break;
        case SENSOR_FEATURE_SET_AUTO_FLICKER_MODE:
             LOG_INF("SENSOR_FEATURE_SET_AUTO_FLICKER_MODE enter \n");
            set_auto_flicker_mode((BOOL)*feature_data_16,*(feature_data_16+1));
            break;
        case SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO:
            LOG_INF("SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO enter \n");
        ...
        case SENSOR_FEATURE_SET_TEST_PATTERN:
             LOG_INF("SENSOR_FEATURE_SET_TEST_PATTERN enter \n");
            set_test_pattern_mode((BOOL)*feature_data);
            break;
        case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE: //for factory mode auto testing
             LOG_INF("SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE enter \n");
            *feature_return_para_32 = imgsensor_info.checksum_value;
            *feature_para_len=4;
            break;
        case SENSOR_FEATURE_SET_FRAMERATE:
             LOG_INF("SENSOR_FEATURE_SET_FRAMERATE enter \n");
...
UINT32 HI841KERR_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}	/*	HI841KERR_MIPI_RAW_SensorInit	*/
