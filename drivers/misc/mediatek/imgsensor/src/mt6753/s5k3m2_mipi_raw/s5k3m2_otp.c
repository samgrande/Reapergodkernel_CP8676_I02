...
#define EEPROM_I2C_SPEED 100 //modified by gaoatao@yulong.com for i2c speed 100k 2015-5-19 19:59:30
...
static int iReadCAM_CAL_16(u32 a_u2Addr, u8 * a_puBuff, u16 i2c_id)
{
 ...
 int i = 0;
 int ret ;
CAM_CALDB("S5K3M2_Read_LSC_Otp  enter\n");
CAM_CALDB("S5K3M2_Read_LSC_Otp  otp_flag=0x %x \n",otp_flag);
 if(otp_flag==1){
...
//modified by gaoatao@yulong.com for read 32k eeprom 2015-3-4 16:45:21 start
    ...
    CAM_CALDB("S5K3M2_Read_LSC_Otp  exit\n");
...
static int iReadData(u32 ui4_offset, u32 ui4_length, BYTE * pinputdata)
{
   ...
   int ret ;
    ...
    {
        CAM_CALDB(" [[CAM_CAL]]S5K3M2_Read_LSC_Otp enter ui4_length = %d,ui4_offset =%d\n ",ui4_length,ui4_offset);//gaoatao add log for test 2014-12-29 11:33:50
