...
u32 pinSet[3][8] = {
    ...
    if (On) {
        ...
        if(pinSetIdx == 0 ) {
            ...
            ISP_MCLK2_EN(1); //modified by gaoatao@yulong.com for MCLK to Mclk2 2015-5-28 10:35:17
        }
#endif
        ...
        else if(currSensorName &&((0 == strcmp(SENSOR_DRVNAME_OV8865_MIPI_RAW,currSensorName)) || (0 == strcmp(SENSOR_DRVNAME_OV8865_QTECH_MIPI_RAW,currSensorName))))
        //Reset
        {
        ...
        if(pinSetIdx == 0 ) {
            ...
            ISP_MCLK2_EN(0);//modified by gaoatao@yulong.com for MCLK to Mclk2 2015-5-28 10:35:17
        }
