...
//    clk_writel(clk->grp->clr_addr, clk->mask);
    ...
    {
    	//mtk add printk here
        printk("AAAAAA[enable]: clk->grp->name=%s, clk->mask=0x%x\n", clk->grp->name, clk->mask);//2015.08.08 lijianbin@yulong.com add for smi test
        clk_writel(clk->grp->clr_addr, clk->mask);
    }
...
//    clk_writel(clk->grp->set_addr, clk->mask);
    ...
    {
    	//mtk add printk here
        printk("AAAAAA[disable]: clk->grp->name=%s, clk->mask=0x%x\n", clk->grp->name, clk->mask);//2015.08.08 lijianbin@yulong.com add for smi test
        clk_writel(clk->grp->set_addr, clk->mask);
    }
