...
#define ACCDET_MIC_MODE (1) // modify baibo@yulong.com for headset config 20150420

// use accdet + EINT solution
#define ACCDET_EINT   //ACC mode // modify baibo@yulong.com for headset config 20150420
#ifndef ACCDET_EINT
