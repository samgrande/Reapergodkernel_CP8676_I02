...
static void init_lcm_registers(void)
{
    ...
    data_array[1] = 0x0B0701CA;
    data_array[2] = 0x1D1A1510;
    data_array[3] = 0x24262719;
    data_array[4] = 0x0411161B;
    data_array[5] = 0x0F0B0701;
    data_array[6] = 0x1C1E1B15;
    data_array[7] = 0x1B212627;
    data_array[8] = 0x00041116;
    dsi_set_cmdq(data_array, 9, 1);
...
#define LCM_COMPARE_ID_OF_LG 0x51
static unsigned int lcm_compare_id(void)
{
    ...
    id = buffer[0];
    #ifdef BUILD_LK
        printf("lk debug: OF_LG id = 0x%x\n", id);
    #endif

    if(LCM_COMPARE_ID_OF_LG == id)
    {
        return 1;
    }
    else
...
LCM_DRIVER r61318_dsi_of_lg_lcm_drv =
{
    .name           = "r61318_dsi_of_lg",
