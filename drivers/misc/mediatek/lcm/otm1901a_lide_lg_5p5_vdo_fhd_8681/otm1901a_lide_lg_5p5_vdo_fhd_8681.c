...
//EMI Setting Modified By gongrui@yulong.com 7-01 Start
        params->dsi.vertical_sync_active                = 2;//1;// 3    2
        params->dsi.vertical_backporch                  = 8;//9;// 20   1
        params->dsi.vertical_frontporch                 = 14; // 1  12
        params->dsi.vertical_active_line                = FRAME_HEIGHT;

        params->dsi.horizontal_sync_active              = 20;//4;// 10  2
        params->dsi.horizontal_backporch                = 32;//50;//100;
        params->dsi.horizontal_frontporch               = 31;//50;//86;
        params->dsi.horizontal_active_pixel             = FRAME_WIDTH;

        params->physical_width = 68;
        params->physical_height = 121;

        params->dsi.PLL_CLOCK=416; //420;
...
//EMI Setting Modified By gongrui@yulong.com 7-01 Start
   //SAP
    ...
    data_array[1] = 0x007A00C0;
    data_array[2] = 0x7A000A0A;
    data_array[3] = 0x7A000A0A;
...
LCM_DRIVER otm1901a_dsi_vdo_lide_lg_lcm_drv =
{
    .name           = "otm1901A_lide_lg",
