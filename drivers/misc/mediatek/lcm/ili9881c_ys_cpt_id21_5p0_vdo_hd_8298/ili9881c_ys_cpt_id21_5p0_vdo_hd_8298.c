...
static void init_lcm_registers(void)
{
    ...
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x190f2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x19102300;
    dsi_set_cmdq(data_array, 1, 1);
    ...
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x336E2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0xC36F2300;
    dsi_set_cmdq(data_array, 1, 1);
    ...
    //VCOM
    //data_array[0] = 0x95532300;
    //dsi_set_cmdq(data_array, 1, 1);
    //data_array[0] = 0xA5552300;
    //dsi_set_cmdq(data_array, 1, 1);
    //data_array[0] = 0xA6502300;

    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x9E512300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x00312300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x14602300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x0FA02300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x1BA12300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x29A22300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x11A32300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x14A42300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x27A52300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x1CA62300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x1DA72300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x8FA82300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x1BA92300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x27AA2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x89AB2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x1BAC2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x18AD2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x4CAE2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x22AF2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x26B02300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x60B12300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x6FB22300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x3FB32300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x01C02300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x1AC12300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x29C22300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x12C32300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x14C42300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x28C52300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x1CC62300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x1DC72300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x8FC82300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x1BC92300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x27CA2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x89CB2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x1BCC2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x18CD2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x4CCE2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x22CF2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x26D02300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x60D12300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x6FD22300;
    dsi_set_cmdq(data_array, 1, 1);
...
#define LCM_COMPARE_ID_YS_CPT 0x21
...
LCM_DRIVER ili9881c_dsi_ys_cpt_id21_lcm_drv =
{
    .name           = "ili9881c_dsi_ys_cpt_id21",
