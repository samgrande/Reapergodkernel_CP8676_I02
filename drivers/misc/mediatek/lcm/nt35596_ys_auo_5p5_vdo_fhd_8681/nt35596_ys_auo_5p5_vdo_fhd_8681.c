...
static void lcm_get_params(LCM_PARAMS *params)
{
        ...
        params->dsi.vertical_backporch                  = 6;//4 20   1
        params->dsi.vertical_frontporch                 = 6; //4 1  12
        params->dsi.vertical_active_line                = FRAME_HEIGHT;

        params->dsi.horizontal_sync_active              = 10;// 10  2
        params->dsi.horizontal_backporch                = 18;//100;
        params->dsi.horizontal_frontporch               = 48;//86;
...
static void init_lcm_registers(void)
{
    ...
    //initial code for yashi otp-IC gongrui@yulong.com 5-12
    ...
    //disable CE function liwei11@yulong.com 2015.6.2
    data_array[0] = 0x00552300;
    dsi_set_cmdq(data_array, 1, 1);

    data_array[0] = 0x00FF2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x07D32300;     //D3 06
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x06D42300;     //D4 04
    dsi_set_cmdq(data_array, 1, 1);

    /* add EMI Setting gongrui@yulong.com 2015.6.24 begin*/
    ...
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x1B1B2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0xF71C2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x0F602300;
    dsi_set_cmdq(data_array, 1, 1);
    ...
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x805D2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x025E2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x005F2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x01662300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x01FB2300;
    dsi_set_cmdq(data_array, 1, 1);
    ...
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x04A62300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x01FB2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0xFFFF2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x034F2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x01FB2300;
    dsi_set_cmdq(data_array, 1, 1);
    /* add EMI Setting gongrui@yulong.com 2015.6.24 end*/

    /* modify for ys spalsh issue liwei11@yulong.com 2015.6.24 begin*/
    data_array[0] = 0x05FF2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x01FB2300;
    dsi_set_cmdq(data_array, 1, 1);
...
static void lcm_suspend(void)
{
    ...
    data_array[0] = 0x01FF2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x03B12300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0xFFB22300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x03ED2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0xFFEE2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x02FF2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x01FB2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x03302300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0xFF312300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x036F2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0xFF702300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x03AD2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0xFFAE2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x03E92300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0xFFEA2300;
    dsi_set_cmdq(data_array, 1, 1);
    data_array[0] = 0x00FF2300;
    dsi_set_cmdq(data_array, 1, 1);
    /* modify for ys spalsh issue liwei11@yulong.com 2015.6.24 end*/
...
LCM_DRIVER nt35596_dsi_vdo_yassy_auo_lcm_drv =
{
    .name           = "nt35596_ys_auo_vdo_fhd",
