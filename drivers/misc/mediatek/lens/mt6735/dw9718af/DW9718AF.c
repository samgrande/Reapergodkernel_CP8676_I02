...
#define LENS_I2C_BUSNUM 0// add gaoatao@yulong.com 20120112 begin
...
static int DW9718AF_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    g_pstDW9718AF_I2Cclient->addr = DW9718AF_VCM_WRITE_ID;// add gaoatao@yulong.com 20120112 begin
