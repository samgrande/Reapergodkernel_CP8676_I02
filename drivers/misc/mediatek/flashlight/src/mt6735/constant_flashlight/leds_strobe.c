...
#define FLASH_USE_GPIO
   ...
   #define FLASH_GPIO_ENF GPIO_CAMERA_FLASH_EN_PIN  //GPIO_CAMERA_FLASH_EN_PIN    //flash pin
   #define FLASH_GPIO_ENT GPIO_FLASH_LED_EN  //GPIO_CAMERA_FLASH_MODE_PIN   //Torch pin
#endif
