...
//start 2015.08.11 lijianbin@yulong.com add for mtk test code
        SMIMSG("[0x280, 0x284, 0x288]=[0x%x,0x%x,0x%x]\n",
            M4U_ReadReg32(u4Base, 0x280), M4U_ReadReg32(u4Base, 0x284),
            M4U_ReadReg32(u4Base, 0x288));

        SMIMSG("[0x28c, 0x290, 0x294]=[0x%x,0x%x,0x%x]\n",
            M4U_ReadReg32(u4Base, 0x28c), M4U_ReadReg32(u4Base, 0x290),
            M4U_ReadReg32(u4Base, 0x294));

        SMIMSG("[0x298, 0x29c, 0x2a0]=[0x%x,0x%x,0x%x]\n",
            M4U_ReadReg32(u4Base, 0x298), M4U_ReadReg32(u4Base, 0x29c),
            M4U_ReadReg32(u4Base, 0x2a0));

        SMIMSG("[0x2a4, 0x2a8, 0x2ac]=[0x%x,0x%x,0x%x]\n",
            M4U_ReadReg32(u4Base, 0x2a4), M4U_ReadReg32(u4Base, 0x2a8),
            M4U_ReadReg32(u4Base, 0x2ac));

        SMIMSG("[0x2b0, 0x2b4, 0x2b8]=[0x%x,0x%x,0x%x]\n",
            M4U_ReadReg32(u4Base, 0x2b0), M4U_ReadReg32(u4Base, 0x2b4),
            M4U_ReadReg32(u4Base, 0x2b8));

        SMIMSG("[0x2bc, 0x2c0, 0x2c4]=[0x%x,0x%x,0x%x]\n",
            M4U_ReadReg32(u4Base, 0x2bc), M4U_ReadReg32(u4Base, 0x2c0),
            M4U_ReadReg32(u4Base, 0x2c4));

        SMIMSG("[0x2c8, 0x2cc, 0x2d0]=[0x%x,0x%x,0x%x]\n",
            M4U_ReadReg32(u4Base, 0x2c8), M4U_ReadReg32(u4Base, 0x2cc),
            M4U_ReadReg32(u4Base, 0x2d0));

        SMIMSG("[0x2d4, 0x2d8, 0x2dc]=[0x%x,0x%x,0x%x]\n",
            M4U_ReadReg32(u4Base, 0x2d4), M4U_ReadReg32(u4Base, 0x2d8),
            M4U_ReadReg32(u4Base, 0x2dc));

        SMIMSG("[0x2e0, 0x2e4, 0x2e8]=[0x%x,0x%x,0x%x]\n",
            M4U_ReadReg32(u4Base, 0x2e0), M4U_ReadReg32(u4Base, 0x2e4),
            M4U_ReadReg32(u4Base, 0x2e8));

        SMIMSG("[0x2ec, 0x2f0, 0x2f4]=[0x%x,0x%x,0x%x]\n",
            M4U_ReadReg32(u4Base, 0x2ec), M4U_ReadReg32(u4Base, 0x2f0),
            M4U_ReadReg32(u4Base, 0x2f4));

        SMIMSG("[0x2f8, 0x2fc]=[0x%x,0x%x]\n",
            M4U_ReadReg32(u4Base, 0x2f8), M4U_ReadReg32(u4Base, 0x2fc));

//end 2015.08.11 lijianbin@yulong.com add for mtk test code
    }else{
...
//start 2015.07.22 lijianbin@yulong.com add mtk test code
...
//end 2015.07.22 lijianbin@yulong.com add mtk test code
