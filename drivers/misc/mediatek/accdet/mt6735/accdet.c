...
static int comip_switch_hook_test_read_proc(char *page, char **start, off_t off,
...
static int comip_switch_hook_test_write_proc(struct file *file, const char __user *buffer,
