...
int dpmgr_get_scenario(disp_path_handle dp_handle);//2015.08.07 lijianbin@yulong.com add for MTK patch 80
int dpmgr_modify_path_power_on_new_modules(disp_path_handle dp_handle, DDP_SCENARIO_ENUM new_scenario, int sw_only);//2015.08.07 lijianbin@yulong.com add for MTK patch 80
...
int dpmgr_modify_path_power_off_old_modules(DDP_SCENARIO_ENUM old_scenario, DDP_SCENARIO_ENUM new_scenario, int sw_only);//2015.08.07 lijianbin@yulong.com add for MTK patch 80
...
int dpmgr_path_enable_irq(disp_path_handle dp_handle, void * cmdq_handle, DDP_IRQ_LEVEL irq_level);//2015.08.07 lijianbin@yulong.com add for MTK patch 80
