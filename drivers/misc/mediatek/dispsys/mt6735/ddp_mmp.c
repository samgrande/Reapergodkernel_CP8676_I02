...
void init_ddp_mmp_events(void)
{
 ...
 //start 2015.08.07 lijianbin@yulong.com add for MTK patch 80
        DDP_MMP_Events.tui =  MMProfileRegisterEvent(DDP_MMP_Events.primary_Parent, "tui"); //modify for P81 by xuzhixian@yulong.com 20150821
...
//end 2015.08.07 lijianbin@yulong.com add for MTK patch 80
        ...
        DDP_MMP_Events.session_release = MMProfileRegisterEvent(DDP_MMP_Events.session_Parent, "session_release");//2015.08.07 lijianbin@yulong.com add for MTK patch 80
        ...
        MMProfileEnableEvent(DDP_MMP_Events.primary_sw_mutex, 0);//2015.08.07 lijianbin@yulong.com add for MTK patch 80
