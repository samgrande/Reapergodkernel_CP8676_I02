...
static DEVICE_ATTR(firmware_update, 0666, touchscreen_firmware_update_show, touchscreen_firmware_update_store);
...
static DEVICE_ATTR(gesture_ctrl, 0222, NULL, touchscreen_gesture_ctrl_store);
static DEVICE_ATTR(smarthull_ctrl, 0222, NULL, touchscreen_smarthull_ctrl_store);//window mode debug by qinxinjun@yulong.com in 20150516
...
static const struct attribute *touchscreen_attrs[] = {
    ...
    &dev_attr_smarthull_ctrl.attr,//window mode debug by qinxinjun@yulong.com in 20150516
    NULL,
};
