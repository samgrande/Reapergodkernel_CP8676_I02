...
//start 2014.11.08 lijianbin@yulong.com add by lijianbin for gesture mode
...
//end 2014.11.08 lijianbin@yulong.com add by lijianbin for gesture mode
/*
...
int synaptics_fw_updater(int Product_ID);
