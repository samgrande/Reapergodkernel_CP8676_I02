...
#include <mach/mt_boot.h> //open TW auto update fw by liuxinyuan@yulong.com in 20150715
...
#endif
/*start open TW auto update fw by liuxinyuan@yulong.com in 20150715*/
    u8 boot_mode = 0;
    char version[60] = {0}; 
/*end open TW auto update fw by liuxinyuan@yulong.com in 20150715*/
...
static void tpd_resume(struct early_suspend *h)
{
    ...
    gtp_reset_guitar(goodix_ts->client, 20); // zhanghongtao@yulong.com 7-5 fix TW report point err
#ifdef TPD_PROXIMITY
