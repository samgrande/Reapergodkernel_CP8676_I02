...
#ifndef _SYNAPTICS_ALT_H_
#define _SYNAPTICS_ALT_H_
 ...
 */
struct synaptics_alt_cap_button_map {
	unsigned char nbuttons;
	unsigned int *map; //modify for report key value which is more than 256 by jingyuantao@yulong.com in 20150806 
};
 ...
 */
struct synaptics_alt_platform_data {
	bool x_flip;
	bool y_flip;
	bool swap_axes;
	int irq_gpio;
	...
	struct synaptics_alt_cap_button_map *cap_button_map;
};
