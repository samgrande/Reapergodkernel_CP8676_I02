...
#ifdef TPD_HAVE_BUTTON
#define TPD_0D_BUTTON		{KEY_CAPSLOCK,KEY_LEFTALT,KEY_SPACE} //modify for reporting key code with double press and long press by qinxinjun@yulong.com in 20150825
#else
