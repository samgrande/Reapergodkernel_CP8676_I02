...
/*start modify by jingyuantao@yulong.com for 1302 and 2333 diff in 20150818*/
#define CHAR_DEVICE_NAME "rmi"
#define DEVICE_CLASS_NAME "rmidev"
#define SYSFS_FOLDER_NAME "rmidev"
#define DEV_NUMBER 1
#define REG_ADDR_LIMIT 0xFFFF
/*end modify by jingyuantao@yulong.com for 1302 and 2333 diff in 20150818*/
...
/*start modify by jingyuantao@yulong.com for 1302 and 2333 diff in 20150818*/
struct class *rmidev_device_class;
EXPORT_SYMBOL(rmidev_device_class);
/*end modify by jingyuantao@yulong.com for 1302 and 2333 diff in 20150818*/
static struct rmidev_handle *rmidev;

DECLARE_COMPLETION(rmidev_remove_complete_alt);
...
static int rmidev_init_device(struct synaptics_rmi4_data *rmi4_data)
{
	...
	if (rmidev_major_num) {
		...
		retval = alloc_chrdev_region(&dev_no, 1, 1, CHAR_DEVICE_NAME); //modify by jingyuantao@yulong.com for 1302 and 2333 diff in 20150818
		if (retval < 0) {
			dev_err(&rmi4_data->i2c_client->dev,
...
exit:
	complete(&rmidev_remove_complete_alt);
...
{
	synaptics_rmi4_new_function_alt(&rmidev_module, true);
...
{
	synaptics_rmi4_new_function_alt(&rmidev_module, false);

	wait_for_completion(&rmidev_remove_complete_alt);
