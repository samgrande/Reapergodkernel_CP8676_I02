...
/*start to define interrrupt and reset GPIO by jingyuantao@yulong.com in 20150805*/
#define GPIO_KEY_EINT_PIN              (GPIO12 | 0x80000000)
#define GPIO_KEY_EINT_PIN_M_GPIO       GPIO_MODE_00
#define GPIO_KEY_EINT_PIN_M_EINT       GPIO_CTP_EINT_PIN_M_GPIO

#define CUST_EINT_KEY_NUM              12
#define CUST_EINT_KEY_DEBOUNCE_CN      0
#define CUST_EINT_KEY_TYPE             CUST_EINTF_TRIGGER_FALLING
#define CUST_EINT_KEY_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE

#define GPIO_KEY_RST_PIN               (GPIO61 | 0x80000000)
/*end to define interrrupt and reset GPIO by jingyuantao@yulong.com in 20150805*/
...
void synaptics_rmi4_new_function_alt(struct synaptics_rmi4_exp_fn *exp_fn_module,
		bool insert);
