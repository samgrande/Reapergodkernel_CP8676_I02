...
static int mtk_uldlloopbackpcm_close(struct snd_pcm_substream *substream)
{
    ...
    SetConnection(Soc_Aud_InterCon_DisConnect, Soc_Aud_InterConnectionInput_I03, Soc_Aud_InterConnectionOutput_O04);
    // modified end.
...
static int mtk_uldlloopback_pcm_prepare(struct snd_pcm_substream *substream)
{
    ...
    SetConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I03, Soc_Aud_InterConnectionOutput_O04);
    // modified end.
